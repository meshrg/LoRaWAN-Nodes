...
static const u1_t PROGMEM DEVEUI[8]={ 0x02, 0xFC, 0xF6, 0x85, 0x99, 0x02, 0x72, 0x67 };
...
static const u1_t PROGMEM APPKEY[16] = { 0x52, 0xE5, 0x4E, 0x35, 0xB9, 0x1D, 0x36, 0xAA, 0xEA, 0x44, 0x98, 0xDB, 0xFB, 0x8B, 0xB9, 0x02 };
...
static uint8_t mydata[3] = {0x01, 0x66, 0x00,}; //0xO1,0x02,0x03,0x04 is Data Channel,0x67,0x68,0x01,0x01 is Data Type
...
int ping(int TriggerPin, int EchoPin) {
   ...
   distanceCm = duration * 0.000001 * 34300/ 2;   //convertimos a distancia, en cm
   return distanceCm;
}
/////////////////////////////////////////////////FIN DE FUNCIÓN DEL SENSOR
void setup() {
    Serial.begin(115200);
